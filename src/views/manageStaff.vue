...
<router-view />
 <div
    ...
    <div class="h-fit w-full  items-center pr-5">
        <h3 class="font-bold text-lg whitespace-nowrap mb-5">Quản tài khoản nhân viên</h3>
...
<script setup>
import Item from '@/components/manageStaffItem.vue';
...
const add = () => {
    router.push({ name: 'manageStaffAdd'});
}
const clearSearch = () => {
    searchInput.value = '';
