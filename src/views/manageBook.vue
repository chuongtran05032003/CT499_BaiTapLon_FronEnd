...
<router-view />
 <div
    ...
    <div class="h-fit w-full  items-center pr-5">
        <h3 class="font-bold text-lg whitespace-nowrap mb-5">Quản lý sách</h3>
            ...
            <thead>
                <tr class="text-left sticky top-0 border-b-2 border-x-0 bg-white m-0 z-20">
                    <th class="p-2 whitespace-nowrap">
                        Mã sách</th>
                    <th class="p-2 w-fit whitespace-nowrap">
                        Tên sách</th>
                    <th class="p-2 whitespace-nowrap">
                        Tác giả</th>
                    <th class="p-2 hidden sm:table-cell whitespace-nowrap">
                        Thể loại</th>
                    <th class="p-2 hidden sm:table-cell whitespace-nowrap">
                        Nhà xuất bản</th>
...
<script setup>
import Item from '@/components/manageBookItem.vue';
...
const add = () => {
    router.push({ name: 'manageBookAdd'});
}
const clearSearch = () => {
    searchInput.value = '';
